...
runtime transport. Runtime socket requests execute on an ordered worker; world access and command replies are
marshalled back onto the BDS server thread through Endstone's scheduler.
