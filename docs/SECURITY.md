...
The M2 controller listens only on `127.0.0.1`, `::1`, or `localhost`; both runtime and plugin reject other configured
...
Profile files reject symlinks/corruption; creation uses the same complete-before-publish mechanism as M1 identity
